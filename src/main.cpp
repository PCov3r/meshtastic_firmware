...
// Two supported RGB LED currently
    ...
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::DFROBOT_LUX, meshtastic_TelemetrySensorType_CUSTOM_SENSOR);
    ...
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::ATTINY_HELPER, meshtastic_TelemetrySensorType_CUSTOM_SENSOR);
